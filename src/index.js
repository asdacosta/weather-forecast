  ...
  if (locationName !== "") {
    ...
    const extractDataAndExecute = (async function () {
      try {
        ...
        const swapIconForSunnyForecasts = (function () {
          ...
          getNodes.futureIcons.forEach((icon, index) => {
            if (futureData[index + 1].day.condition.text === "Partly cloudy") {
              icon.innerHTML =
            ...
            if (futureData[index + 1].day.condition.text === "Sunny") {
              icon.innerHTML =
            ...
            if (
              futureData[index + 1].day.condition.text === "Cloudy" ||
              futureData[index + 1].day.condition.text === "Overcast" ||
              futureData[index + 1].day.condition.text === "Fog" ||
              futureData[index + 1].day.condition.text === "Clear"
            ) {
              icon.innerHTML =
            ...
            if (futureData[index + 1].day.condition.text.includes("snow")) {
              icon.innerHTML =
            ...
            if (
              futureData[index + 1].day.condition.text === "Blizzard" ||
              futureData[index + 1].day.condition.text.includes("Thundery")
            ) {
              icon.innerHTML =
